...
public class WoolStatementCommandBody {
	private ArrayList<WoolStatement> statements;
	private ArrayList<WoolReply> replies;
	
	// ---------- Constructors:
	
	public WoolStatementCommandBody() { 
		statements = new ArrayList<WoolStatement>();
		replies = new ArrayList<WoolReply>();
	}
	
	public WoolStatementCommandBody(ArrayList<WoolStatement> statements, ArrayList<WoolReply> replies) {
